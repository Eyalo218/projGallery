var gProj = [
    ...
    {
        id: 'traveltip', name: 'TravelTip', title: 'I can guess who you\'re thinking off',
        desc: 'guesses who you\'re thinking off and will learn from his mistakes', url: 'projs/TravelTip/',
        publishedAt: new Date(), labels: ['Bootstrap', 'Jquery', 'Modals']
    }
];
